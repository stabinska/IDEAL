function [FitResults,FitQuality,Params,ROIstat] = IDEALfitIVIM(path_Data,Params,path_Mask,path_ROI)
%IDEALfitIVIM(path_Data 'string', Params 'struct', path_Mask 'string', path_ROI 'cell')
% 
...
%% Parse input arguments and load data,mask and ROIs if supplied
    ...
    if nargin < 4
        ...
        [Data_raw, Mask_raw, Data_raw_masked,ROIs,T1map,Params] = ...
